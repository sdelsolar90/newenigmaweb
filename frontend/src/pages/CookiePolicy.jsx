      ...
      <section className="py-20 bg-void">
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-surface border border-border p-8 sm:p-12 space-y-10 font-body text-sm text-muted leading-relaxed">
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">1. ¿Qué son las cookies?</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">2. Responsable del uso de cookies</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">3. Tipos de cookies que utilizamos</h2>

              <div className="space-y-6">
                <div>
                  <h3 className="font-heading text-base font-semibold text-text mb-2">Cookies esenciales</h3>
                ...
                <div>
                  <h3 className="font-heading text-base font-semibold text-text mb-2">Cookies de analítica</h3>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">4. Finalidad de las cookies</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">5. Duración de las cookies</h2>
              <p className="mb-3">Según su duración, las cookies que utilizamos se clasifican en:</p>
              <ul className="space-y-3 list-disc list-inside">
                <li><span className="text-text">Cookies de sesión:</span> se eliminan automáticamente al cerrar el navegador.</li>
                <li><span className="text-text">Cookies persistentes:</span> permanecen en tu dispositivo durante un período determinado o hasta que las elimines manualmente. Las cookies de consentimiento se conservan durante 12 meses. Las cookies de analítica pueden conservarse hasta 24 meses.</li>
              </ul>
            </div>

            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">6. Gestión de cookies desde el navegador</h2>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener noreferrer" className="text-indigo-light hover:text-indigo-soft transition-colors">Google Chrome</a>
                </li>
                <li>
                  <a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias" target="_blank" rel="noopener noreferrer" className="text-indigo-light hover:text-indigo-soft transition-colors">Mozilla Firefox</a>
                </li>
                <li>
                  <a href="https://support.apple.com/es-es/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-indigo-light hover:text-indigo-soft transition-colors">Safari</a>
                </li>
                <li>
                  <a href="https://support.microsoft.com/es-es/microsoft-edge/eliminar-las-cookies-en-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-indigo-light hover:text-indigo-soft transition-colors">Microsoft Edge</a>
                </li>
              </ul>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">7. Modificaciones</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">8. Contacto</h2>
