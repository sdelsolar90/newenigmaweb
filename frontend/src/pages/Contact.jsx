          ...
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
            <div className="lg:col-span-3">
              ...
              >
                ...
                <div className="mt-5">
                  <label htmlFor="message" className="block font-body text-sm font-medium text-text mb-1.5">
                ...
                <button
                  ...
                  className="mt-6 w-full inline-flex items-center justify-center gap-2 py-4 rounded-sm font-body text-base font-semibold text-off-white bg-indigo hover:bg-indigo-deep hover:shadow-lg hover:shadow-indigo/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {status === "sending" ? (
                    <>
            ...
            <div className="lg:col-span-2">
              ...
              >
                <div className="p-6 bg-surface border border-border">
                  <h3 className="font-heading text-lg font-semibold text-off-white mb-4">Escríbenos directamente</h3>
                  <div className="space-y-4">
                    <a
                      href="https://wa.me/51959561015?text=Hola%2C%20me%20interesa%20saber%20más%20sobre%20los%20servicios%20de%20Enigma"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-4 p-4 bg-surface2 border border-border hover:border-indigo/20 transition-all duration-200 group"
                    >
                      ...
                      <div>
                        <span className="block font-body text-sm font-semibold text-off-white group-hover:text-indigo-light transition-colors">WhatsApp</span>
                        <span className="block font-body text-xs text-muted">Respuesta inmediata</span>
                      </div>
                    </a>
                    ...
                    <a
                      ...
                      className="flex items-center gap-4 p-4 bg-surface2 border border-border hover:border-indigo/20 transition-all duration-200 group"
                    >
                      <div className="w-10 h-10 bg-indigo/10 border border-indigo/20 text-indigo-light flex items-center justify-center shrink-0">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
                      </div>
                      <div>
                        <span className="block font-body text-sm font-semibold text-off-white group-hover:text-indigo-light transition-colors">Email</span>
                        <span className="block font-body text-xs text-muted">hello@enigmasac.com</span>
                      </div>
                    </a>
                  </div>
                </div>
                ...
                <div className="p-6 bg-surface border border-border">
                  <h3 className="font-heading text-lg font-semibold text-off-white mb-4">Teléfonos</h3>
                  <div className="space-y-3">
                    <a href="tel:+51959561015" className="flex items-center gap-3 font-body text-sm text-muted hover:text-indigo-light transition-colors">
                      <span className="px-2 py-0.5 bg-indigo/10 border border-indigo/20 text-xs font-mono text-indigo-light">PE</span>
                      +51 959 561 015
                    </a>
                    <a href="tel:+34656663992" className="flex items-center gap-3 font-body text-sm text-muted hover:text-indigo-light transition-colors">
                      <span className="px-2 py-0.5 bg-indigo/10 border border-indigo/20 text-xs font-mono text-indigo-light">ES</span>
                      +34 656 663 992
                    </a>
                  </div>
                </div>
                ...
                <div className="p-6 bg-surface2 border border-border">
                  <h3 className="font-heading text-lg font-semibold text-off-white mb-2">¿Prefieres que te llamemos?</h3>
