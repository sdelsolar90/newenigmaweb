      ...
      <section className="py-20 bg-void">
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-surface border border-border p-8 sm:p-12 space-y-10 font-body text-sm text-muted leading-relaxed">
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">1. Responsable del tratamiento</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">2. Datos que recopilamos</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">3. Finalidad del tratamiento</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">4. Base legal</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">5. Conservación de datos</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">6. Compartición de datos</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">7. Seguridad</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">8. Derechos del titular</h2>
              ...
              <p className="mt-3">Para ejercer estos derechos, envía un correo a <a href="mailto:hello@enigmasac.com" className="text-indigo-light hover:text-indigo-soft transition-colors">hello@enigmasac.com</a> indicando tu solicitud y datos de identificación.</p>
            </div>

            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">9. Cookies</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">10. Modificaciones</h2>
            ...
            <div>
              <h2 className="font-heading text-lg font-semibold text-off-white mb-4">11. Contacto</h2>
