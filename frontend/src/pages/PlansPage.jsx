...
const FAQ = [
  ...
  { question: "¿Los precios son iguales para Perú y España?", answer: "Los precios se adaptan al mercado local. Agenda un diagnóstico gratuito y te enviamos una propuesta personalizada según tu ubicación y necesidades." },
