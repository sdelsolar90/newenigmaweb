        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:hello@enigmasac.com" className="flex items-center gap-3 py-3 font-body text-sm text-cream2 hover:text-red transition-colors duration-200">
              ...
              <li className="flex items-start gap-3 font-body text-sm text-cream2">
                ...
                <div className="space-y-0">
                  <a href="tel:+51959561015" className="block py-3 hover:text-red transition-colors duration-200">{t("footer.phonePeru")}</a>
                  <a href="tel:+34656663992" className="block py-3 hover:text-red transition-colors duration-200">{t("footer.phoneSpain")}</a>
                </div>
              </li>
              <li className="flex items-start gap-3 font-body text-sm text-cream2">
