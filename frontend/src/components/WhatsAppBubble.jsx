      ...
      {visible && (
        ...
        >
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                ...
                className="relative bg-carbon2 border border-line shadow-lg shadow-carbon/50 px-4 py-3 max-w-[200px] cursor-pointer"
          ...
          >
            ...
            <span className="absolute -top-1 -right-1 w-4 h-4 bg-red rounded-full border-2 border-carbon2 animate-pulse" />
          </a>
        </motion.div>
      )}
    </AnimatePresence>
